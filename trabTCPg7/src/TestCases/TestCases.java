...
public class TestCases
{
	...
	@Test public void testAddFuncionarios ()
	{
	...
	@Test public void testAddMesasNosSetores ()
	{
		s.addMesa (m1);
		s2.addMesa (m2);
	...
	@Test public void testAddSetores ()
	{
		assertEquals (setor.add (s), true);
		assertEquals (setor.add (s2), true);
	}

	@Test (expected = SemTurnoAtivoException.class) public void testingException () throws Exception
	{
		senta.execute ();
	}
}
