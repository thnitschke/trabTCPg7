...
/**
 * Uma classe para facilitar o rastreamento da preparação de itens em pedidos. Guarda um item e
 * seu estado de preparação, com getters e setters pra cada um dos atributos.
 * 
...
public class ItemPedido
{
	 ...
	 * 
	 * @param estado Recebe por parâmetro um objeto do tipo Estado para fazer a modificação.
	 */
