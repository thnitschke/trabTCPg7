...
/**
 * Guarda as informações sobre o pedido de uma mesa. Uma mesa não pode conter mais de um
 * pedido. Ele contém um mapa relacionando seus itens com o estado de preparação de cada um.
 * Além disso, ele possui um atributo indicando seu estado de preparação e o garçom responsável
 * pelo pedido.
 *
...
public class Pedido
{
	 ...
	 * 
	 * @param garcom Recebe um garçom.
	 * @param itens Recebe uma lista de Itens.
	 */
	 ...
	 * 
	 * @param estado Recebe um estado por parâmetro para associar ao pedido.
	 */
	...
	/**
	 * Modifica todos os estados de uma lista de itens, para um determinado estado. 
	 * 
	 * @param itens Recebe uma lista de objetos do tipo Item.
	...
	/** (NEW)
	 * Pega a lista de itens do pedido.
	 * 
	 ...
	 * 
	 * @param pedido Recebe um pedido por parâmetro.
	 */
	...
	/** (Mudança do nome para adicionaItem - seguido Relatório)
	 * Adiciona um pedido do cliente para a lista de pedidos.
	 * 
	...
	public void adicionaItem (Item item)
	{
		...
		boolean added = false;
		// Se vazio apenas adiciona o item. Caso contrário deve verificar a lista 
